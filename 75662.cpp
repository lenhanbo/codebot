...
#ifndef CFG_DEADLINE_MS
#define CFG_DEADLINE_MS 65
#endif
#ifndef CFG_EXPLORERS
#define CFG_EXPLORERS 3
#endif
#ifndef CFG_LOCAL_MUTS
#define CFG_LOCAL_MUTS 2
#endif
#ifndef CFG_ENDGAME_TURN
#define CFG_ENDGAME_TURN 160
#endif
#ifndef CFG_GOLD_SLACK
#define CFG_GOLD_SLACK 100
#endif
#ifndef CFG_WHQ
#define CFG_WHQ 10
#endif
...
struct SearchCfg {
  int pop           = 20;
  long long deadline_ms = CFG_DEADLINE_MS;
  int tournament_k  = 2;
  int explorers     = CFG_EXPLORERS;
  int local_muts    = CFG_LOCAL_MUTS;
  int max_gens      = 4000;
  int endgame_turn  = CFG_ENDGAME_TURN;
...
struct EndgameCfg {
  int def_radius = 2;
  int gold_slack = CFG_GOLD_SLACK;
  long long wHQ = CFG_WHQ;
  long long wEHQ = CFG_WEHQ;
  long long wEST = CFG_WEST;
};
